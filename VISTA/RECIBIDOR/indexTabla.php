        ...
        <table class="table table-hover">
          ...
          <tr>
            ...
            <td> <?php switch ($pro['tipo']) {
                      case 1:
                          echo "<h3><span class='label label-success'>Secado al Aire</span></h3>";
                          break;
                      case 2:
                          echo "<h3><span class='label label-danger'>Secado al Sol</span></h3>";
                          break;
                      case 3:
                          echo "<h3><span class='label label-info'>Esta en Lavado</span></h3>";
                          break;
                  }  ?></td>
