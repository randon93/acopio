<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><i class="fas fa-cog"></i> Administrar PROCESO</h1>
			</div>
			<div class="col-md-2">
				<a href="<?Php echo constant('URL');?>LOGIN/cerrar"><button type="button" class="btn btn-outline-light " data-toggle="modal"
					data-target="#modalSesion">Cerrar Sesion</button></a>
			</div>
		</div>
	</div>
</header>
