...
<head>
  ...
  <link rel="stylesheet" href="<?php echo constant('URL');?>PUBLICO/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo constant('URL');?>PUBLICO/bower_components/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?PHP ECHO constant('URL');?>PUBLICO/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?PHP ECHO constant('URL');?>PUBLICO/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo constant('URL');?>"><i class="fa fa-link"></i> <span>Link</span></a></li>
