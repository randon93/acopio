...
<html lang="en">
  ...
  <body>
    ...
    <section class="page-section clearfix" id="home">
      <div class="container">
        <div class="intro">
          <img style="height: 600px;" class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="<?php echo constant('URL');?>PUBLICO/IMAGENES/CAFE6.jpg" alt="">
    ...
    <section class="page-section" id="produc">
      <div class="container">
        <div class="product-item">
          ...
          <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="<?php echo constant('URL');?>PUBLICO/IMAGENES/products-03.jpg" alt="">
